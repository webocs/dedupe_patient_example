...
input_file = 'pacientes.csv'
output_file = 'pacientes_output.csv'
settings_file = 'pacientes_learned_settings'
training_file = 'pacientes_training.json'
...
if os.path.exists(settings_file):
    ...
    #idPaciente,documento,estado,nombre,apellido,sexo,genero,fechaNacimiento,estadoCivil,claveSn
    ...
    # blocking predicates
    deduper.train(maximum_comparisons=500000000, recall=0.9)
